...
public class Accelerometer extends AppCompatActivity implements SensorEventListener2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonStart.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                manager.registerListener(Accelerometer.this, manager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER), 100000);

                manager.registerListener(Accelerometer.this, manager.getDefaultSensor(Sensor.TYPE_GYROSCOPE), 100000);
                ...
                manager.registerListener(Accelerometer.this, manager.getDefaultSensor(Sensor.TYPE_STEP_COUNTER), 100000);
        ...
        buttonStop.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                manager.flush(Accelerometer.this);

                manager.unregisterListener(Accelerometer.this);
            ...
            try {
                ...
                switch(evt.sensor.getType()) {
                    ...
                    case Sensor.TYPE_STEP_COUNTER:
                        ...
                        writer.write(String.format("%d; STEP;  %f\n", evt.timestamp, evt.values[0],  0.f));
